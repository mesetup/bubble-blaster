    ...
    private static Restriction parseRestriction(String spec)
        ...
        if (index < 0) {
            ...
            if (lowerBound.equals(upperBound)) {
                throw new InvalidVersionSpecificationException("IntegerRange cannot have identical boundaries: " + spec);
            }
            ...
            if (upperVersion != null && lowerVersion != null && upperVersion.compareTo(lowerVersion) < 0) {
                throw new InvalidVersionSpecificationException("IntegerRange defies version ordering: " + spec);
            }
...
*/
    ...
    public String getLowerBoundString() {
        return restrictions.size() == 1 ? Objects.requireNonNull(restrictions.get(0).getLowerBound()).getVersionString() : "";
    }
