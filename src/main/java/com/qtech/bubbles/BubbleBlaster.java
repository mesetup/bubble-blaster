...
import com.qtech.bubbles.common.TimeProcessor;
...
import com.qtech.bubbles.event.bus.GameEventBus;
...
import com.qtech.bubbles.rendering.RenderSettings;
import com.qtech.bubbles.rendering.TextureManager;
...
//        getRenderThread().start();
    ...
    private void render() {
        ...
        gg.scale(1 / renderSettings.getScale(), 1 / renderSettings.getScale());
...
//            System.exit(1);
    ...
    public void showScreen(@Nullable Screen scene) {
        this.screenManager.displayScreen(scene);
    }

    public void showScreen(Screen scene, boolean force) {
