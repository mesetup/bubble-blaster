...
public final class BubbleBlaster extends Canvas {
    ...
    // Logger.
    @Getter
    private static final Logger logger = LogManager.getLogger("BB:Generic");
    ...
    public BubbleBlaster() throws IOException {
        ...
        GraphicsProcessor gg = new GraphicsProcessor(cursorImg1.createGraphics());
        ...
        GraphicsProcessor gg3 = new GraphicsProcessor(cursorImg3.createGraphics());
        ...
        Thread.setDefaultUncaughtExceptionHandler(new BBExceptionHandler());
...
//        getRenderThread().start();
    ...
    private void render() {
        ...
        GraphicsProcessor gp = new GraphicsProcessor(bs.getDrawGraphics());

        FilterApplier filterApplier = new FilterApplier(getBounds().getSize(), this);
        GraphicsProcessor g2d = filterApplier.getGraphics();
        ...
        // Draw filtered image.
        gp.drawImage(filterApplier.done(), 0, 0, this);

        if (getScreenManager().getCurrentScreen() != null)
            getScreenManager().getCurrentScreen().renderGUI(this, gp);
