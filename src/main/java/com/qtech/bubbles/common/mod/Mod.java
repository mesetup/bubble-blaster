...
public @interface Mod {
    ...
    @interface EventBusSubscriber {
        ...
        enum Bus {
             ...
             *
             * @see com.qtech.bubbles.event.bus.Bus#getQBubblesEventBus()
             */
            QBUBBLES(com.qtech.bubbles.event.bus.Bus::getQBubblesEventBus),
            /**
             * The addon specific Event bus.
             *
             * @see com.qtech.bubbles.event.bus.Bus#getAddonEventBus()
             */
            MOD(com.qtech.bubbles.event.bus.Bus::getAddonEventBus);
