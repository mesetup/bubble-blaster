...
public class EntitySpawnData {
    ...
    public static EntitySpawnData fromLoadSpawn(@NonNull BsonDocument state) {
        return new EntitySpawnData(SpawnReason.LOAD, state, null, null, QBubbles.getInstance().environment);
    }

    public static EntitySpawnData fromNaturalSpawn(Point pos) {
        return new EntitySpawnData(SpawnReason.NATURAL, null, pos, null, QBubbles.getInstance().environment);
    }
    ...
    public static EntitySpawnData fromCommand(Command command) {
        return new EntitySpawnData(SpawnReason.COMMAND, null, null, command, QBubbles.getInstance().environment);
    }
