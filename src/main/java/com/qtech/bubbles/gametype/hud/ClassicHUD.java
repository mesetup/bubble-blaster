    ...
    public void renderHUD(GraphicsProcessor gg) {
        ...
        try {
            ...
            for (EffectInstance effectInstance : Objects.requireNonNull(player).getActiveEffects()) {
                ...
                GraphicsProcessor graphics2D = (GraphicsProcessor) gg.create(320 + i * 196, 16, 192, 38);
                ...
                // EffectInstance icon.
                graphics2D.drawImage(effectInstance.getType().getIcon(32, 32, new Color(0, 191, 191)), 5, 3, BubbleBlaster.getInstance());
...
//                gg.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
        ...
        if (!gameOver) {
            if (player != null) {
                gg.setColor(titleColor);
                GraphicsUtils.drawCenteredString(gg, I18n.translateToLocal("info.bubbleblaster.score"), new Rectangle(10, 10, 80, 20), infoTitleFont);
                ...
                gg.setColor(titleColor);
                GraphicsUtils.drawCenteredString(gg, I18n.translateToLocal("info.bubbleblaster.level"), new Rectangle(100, 10, 80, 20), infoTitleFont);
                gg.setColor(descriptionColor);
                GraphicsUtils.drawCenteredString(gg, String.valueOf(player.getLevel()), new Rectangle(100, 40, 80, 20), infoValueFont);

                gg.setColor(titleColor);
                GraphicsUtils.drawCenteredString(gg, I18n.translateToLocal("info.bubbleblaster.health"), new Rectangle(210, 10, 80, 20), infoTitleFont);
                int greenValue;
                int redValue;
