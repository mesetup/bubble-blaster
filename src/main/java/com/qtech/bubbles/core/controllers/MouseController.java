...
public class MouseController extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        BubbleBlaster.getEventBus().post(new com.qtech.bubbles.event.MouseEvent(BubbleBlaster.getInstance(), this, e, MouseEventType.CLICK));
    }
    ...
    public void mousePressed(MouseEvent e) {
        ...
        BubbleBlaster.getEventBus().post(new com.qtech.bubbles.event.MouseEvent(BubbleBlaster.getInstance(), this, e, MouseEventType.PRESS));
    }
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        BubbleBlaster.getEventBus().post(new com.qtech.bubbles.event.MouseEvent(BubbleBlaster.getInstance(), this, e, MouseEventType.RELEASE));
    }
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        currentLocationOnScreen = e.getLocationOnScreen() != null ? e.getLocationOnScreen() : currentLocationOnScreen;
        currentPoint = e.getPoint() != null ? e.getPoint() : currentPoint;
        BubbleBlaster.getEventBus().post(new com.qtech.bubbles.event.MouseWheelEvent(BubbleBlaster.getInstance(), this, e, MouseEventType.MOTION));
