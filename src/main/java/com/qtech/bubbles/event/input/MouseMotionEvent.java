 ...
 *
 * @see com.qtech.bubbles.event.input.MouseEvent
...
public class MouseMotionEvent extends Event {
     ...
     */
    public MouseMotionEvent(BubbleBlaster main, @NotNull MouseController controller, MouseEvent event, MouseEventType type) {
        this.main = main;
        this.type = type;
