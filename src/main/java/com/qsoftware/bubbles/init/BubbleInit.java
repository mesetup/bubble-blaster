...
import com.qsoftware.bubbles.bubble.*;
...
public class BubbleInit implements ObjectInit<AbstractBubble> {
    ...
    public static final RegistryObject<AbstractBubble> BUBBLE_FREEZE_BUBBLE = register("bubble_freeze", () -> AbstractBubble.builder()
            ...
            .score(1.3125f)
            .effect((source, target) -> (new EffectInstance(EffectInit.BUBBLE_FREEZE.get(), source.getRadius() / 8, (byte) ((byte) source.getSpeed() * 4))))
    ...
    public static final RegistryObject<AbstractBubble> PARALYZE_BUBBLE = register("paralyze", () -> AbstractBubble.builder()
            ...
            .score(0.325f)
            .effect((source, target) -> (new EffectInstance(EffectInit.PARALYZE.get(), source.getRadius() / 16, (byte) 1)))
    ...
    public static final RegistryObject<AbstractBubble> POISON_BUBBLE = register("poison", () -> AbstractBubble.builder()
            ...
            .effect((source, target) -> (new EffectInstance(EffectInit.POISON.get(), source.getRadius() / 8, (byte) ((byte) source.getSpeed() * 4))))
            .build());
