...
import com.qsoftware.bubbles.event.MouseEvent;
...
import com.qsoftware.bubbles.graphics.Border;
...
//                text += c;
    ...
    public void render(QBubbles game, Graphics2D gg) {
        ...
        Graphics2D gg1 = (Graphics2D) gg.create(bounds.x, bounds.y, bounds.width, bounds.height);
