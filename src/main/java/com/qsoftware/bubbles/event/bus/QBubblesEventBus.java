...
public class QBubblesEventBus extends EventBus {
    ...
    public Map<Class<? extends Event>, CopyOnWriteArraySet<Pair<Object, Method>>> eventToMethod = new HashMap<>();

    public HashMap<Pair<Object, Method>, CopyOnWriteArraySet<Class<? extends Event>>> methodToEvent = new HashMap<>();
