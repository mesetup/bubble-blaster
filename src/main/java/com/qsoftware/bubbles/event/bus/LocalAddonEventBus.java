...
public class LocalAddonEventBus<J extends QBubblesAddon> extends EventBus {
    ...
    public HashMap<Class<? extends Event>, HashSet<Pair<Object, Method>>> eventToMethod = new HashMap<>();

    public HashMap<Pair<Object, Method>, HashSet<Class<? extends Event>>> methodToEvent = new HashMap<>();
