...
public final class LanguageScene extends Scene {
    private static LanguageScene INSTANCE;
    ...
    private class LanguageLoader {
        @SubscribeEvent
        public void onLoadComplete(LoaderLoadCompleteEvent evt) {
            LanguageScene.this.onPostInitialize();
        }
    }

    public LanguageScene(Scene backScene) {
        LanguageScene.INSTANCE = this;
    ...
    private void onPostInitialize() {
        for (Locale locale : LocaleRegistry.getRegistry().keys()) {
            String name;
