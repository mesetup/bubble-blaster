...
public final class LocaleRegistry extends AbstractRegistry<Locale, LanguageMap> {
    ...
    public static LocaleRegistry getRegistry() {
        return new LocaleRegistry();
    }

    protected LocaleRegistry() throws IllegalStateException {
