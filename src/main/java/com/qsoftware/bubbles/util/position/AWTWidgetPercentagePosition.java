...
import com.qsoftware.bubbles.util.position.util.RelativeAnchor;
...
public class AWTWidgetPercentagePosition extends PercentagePosition {
     ...
     * @see Position
     */
    public AWTWidgetPercentagePosition(Component component, int percentX, int percentY, RelativeAnchor anchor) {
