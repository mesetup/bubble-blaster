 ...
 * An empty {@link ListTag} will be of type {@link net.querz.nbt.tag.EndTag} (unknown type).
 ...
 */
public class ListTag<T extends net.querz.nbt.tag.Tag<?>> extends net.querz.nbt.tag.Tag<List<T>> implements Iterable<T>, Comparable<ListTag<T>>, MaxDepthIO {
     ...
     * @throws IllegalArgumentException When {@code typeClass} is {@link net.querz.nbt.tag.EndTag}{@code .class}
     * @throws NullPointerException     When {@code typeClass} is {@code null}
     */
    public ListTag(Class<? extends T> typeClass) throws IllegalArgumentException, NullPointerException {
        this(typeClass, 3);
    }
     ...
     * @throws NullPointerException     When {@code typeClass} is {@code null}
     */
    public ListTag(Class<? extends T> typeClass, int initialCapacity) throws IllegalArgumentException, NullPointerException {
        super(createEmptyValue(initialCapacity));
        if (typeClass == net.querz.nbt.tag.EndTag.class) {
    ...
    public Class<?> getTypeClass() {
        return typeClass == null ? net.querz.nbt.tag.EndTag.class : typeClass;
    }
    ...
    public void add(int index, T t) {
        ...
        if (getTypeClass() == net.querz.nbt.tag.EndTag.class) {
    ...
    public void addBoolean(boolean value) {
        addUnchecked(new net.querz.nbt.tag.ByteTag(value));
    }
    ...
    public void addDouble(double value) {
        addUnchecked(new net.querz.nbt.tag.DoubleTag(value));
    }
    ...
    public void addIntArray(int[] value) {
        addUnchecked(new net.querz.nbt.tag.IntArrayTag(value));
    }
    ...
    public <L extends net.querz.nbt.tag.Tag<?>> ListTag<L> asTypedList(Class<L> type) {
        checkTypeClass(type);
        return (ListTag<L>) this;
    }

    public ListTag<net.querz.nbt.tag.ByteTag> asByteTagList() {
    ...
    public ListTag<net.querz.nbt.tag.DoubleTag> asDoubleTagList() {
    ...
    public ListTag<net.querz.nbt.tag.IntArrayTag> asIntArrayTagList() {
    ...
    public ListTag<net.querz.nbt.tag.CompoundTag> asCompoundTagList() {
    ...
    public void addUnchecked(Tag<?> tag) {
        if (getTypeClass() != net.querz.nbt.tag.EndTag.class && typeClass != tag.getClass()) {
