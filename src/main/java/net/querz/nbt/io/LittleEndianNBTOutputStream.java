...
public class LittleEndianNBTOutputStream implements DataOutput, NBTOutput, MaxDepthIO, Closeable {
    ...
    private static final Map<Byte, ExceptionTriConsumer<LittleEndianNBTOutputStream, net.querz.nbt.tag.Tag<?>, Integer, IOException>> writers = new HashMap<>();
    ...
    static {
        ...
        put(net.querz.nbt.tag.ListTag.ID, LittleEndianNBTOutputStream::writeList, net.querz.nbt.tag.ListTag.class);
        put(net.querz.nbt.tag.CompoundTag.ID, LittleEndianNBTOutputStream::writeCompound, net.querz.nbt.tag.CompoundTag.class);
    ...
    private static void put(byte id, ExceptionTriConsumer<LittleEndianNBTOutputStream, net.querz.nbt.tag.Tag<?>, Integer, IOException> f, Class<?> clazz) {
        writers.put(id, f);
    ...
    public void writeRawTag(net.querz.nbt.tag.Tag<?> tag, int maxDepth) throws IOException {
        ExceptionTriConsumer<LittleEndianNBTOutputStream, net.querz.nbt.tag.Tag<?>, Integer, IOException> f;
    ...
    private static void writeByte(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeByte(((net.querz.nbt.tag.ByteTag) tag).asByte());
    }

    private static void writeShort(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeShort(((net.querz.nbt.tag.ShortTag) tag).asShort());
    }

    private static void writeInt(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeInt(((net.querz.nbt.tag.IntTag) tag).asInt());
    }

    private static void writeLong(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeLong(((net.querz.nbt.tag.LongTag) tag).asLong());
    }

    private static void writeFloat(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeFloat(((net.querz.nbt.tag.FloatTag) tag).asFloat());
    }

    private static void writeDouble(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeDouble(((net.querz.nbt.tag.DoubleTag) tag).asDouble());
    }

    private static void writeString(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeUTF(((net.querz.nbt.tag.StringTag) tag).getValue());
    }

    private static void writeByteArray(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
        out.writeInt(((net.querz.nbt.tag.ByteArrayTag) tag).length());
        out.write(((net.querz.nbt.tag.ByteArrayTag) tag).getValue());
    }

    private static void writeIntArray(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
    ...
    private static void writeLongArray(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag) throws IOException {
    ...
    private static void writeList(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag, int maxDepth) throws IOException {
    ...
    private static void writeCompound(LittleEndianNBTOutputStream out, net.querz.nbt.tag.Tag<?> tag, int maxDepth) throws IOException {
