...
public final class NBTUtil {
    ...
    public static void write(NamedTag tag, OutputStream out) throws IOException {
        write(tag, out, true);
    }
    ...
    public static void write(net.querz.nbt.tag.Tag<?> tag, File file, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), file, compressed);
    }

    public static void write(net.querz.nbt.tag.Tag<?> tag, OutputStream out, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), out, compressed);
    }

    public static void write(net.querz.nbt.tag.Tag<?> tag, String file, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), new File(file), compressed);
    }

    public static void write(net.querz.nbt.tag.Tag<?> tag, File file) throws IOException {
        write(new NamedTag(null, tag), file, true);
    }

    public static void write(net.querz.nbt.tag.Tag<?> tag, OutputStream out) throws IOException {
        write(new NamedTag(null, tag), out, true);
    }

    public static void write(net.querz.nbt.tag.Tag<?> tag, String file) throws IOException {
    ...
    public static void writeLE(NamedTag tag, OutputStream out, boolean compressed) throws IOException {
    ...
    public static void writeLE(NamedTag tag, OutputStream out) throws IOException {
    ...
    public static void writeLE(net.querz.nbt.tag.Tag<?> tag, File file, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), file, compressed);
    }

    public static void writeLE(net.querz.nbt.tag.Tag<?> tag, OutputStream out, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), out, compressed);
    }

    public static void writeLE(net.querz.nbt.tag.Tag<?> tag, String file, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), new File(file), compressed);
    }

    public static void writeLE(net.querz.nbt.tag.Tag<?> tag, File file) throws IOException {
        writeLE(new NamedTag(null, tag), file, true);
    }

    public static void writeLE(net.querz.nbt.tag.Tag<?> tag, OutputStream out) throws IOException {
        writeLE(new NamedTag(null, tag), out, true);
    }
    ...
    public static NamedTag read(InputStream in) throws IOException {
        return new NBTDeserializer(false).fromStream(detectDecompression(in));
    }
    ...
    public static NamedTag readLE(InputStream in, boolean compressed) throws IOException {
        return new NBTDeserializer(compressed, true).fromStream(in);
    }
    ...
    public static NamedTag readLE(InputStream in) throws IOException {
