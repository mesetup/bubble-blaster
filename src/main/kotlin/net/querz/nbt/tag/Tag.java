 ...
 * If an instance is nested further than allowed, a {@link net.querz.io.MaxDepthReachedException} will be thrown.
...
public abstract class Tag<T> implements Cloneable {
     ...
     *
     * @throws net.querz.io.MaxDepthReachedException If the maximum nesting depth is exceeded.
