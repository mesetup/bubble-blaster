...
public class ListTag<T extends Tag<?>> extends Tag<List<T>> implements Iterable<T>, Comparable<ListTag<T>>, MaxDepthIO {
    ...
    public void addLong(long value) {
        addUnchecked(new net.querz.nbt.tag.LongTag(value));
    }
    ...
    public void addByteArray(byte[] value) {
        addUnchecked(new net.querz.nbt.tag.ByteArrayTag(value));
    }
    ...
    public ListTag<net.querz.nbt.tag.LongTag> asLongTagList() {
    ...
    public ListTag<net.querz.nbt.tag.ByteArrayTag> asByteArrayTagList() {
