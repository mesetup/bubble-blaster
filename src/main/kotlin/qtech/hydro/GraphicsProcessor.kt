...
import qtech.bubbles.core.utils.categories.StringUtils.createFallbackString
import qtech.bubbles.core.utils.categories.StringUtils.splitIntoLines
import qtech.bubbles.core.utils.categories.StringUtils.wrap
import qtech.hydro.shapes.Circle
import qtech.hydro.shapes.CircleDouble
import qtech.hydro.shapes.CircleFloat
...
class GraphicsProcessor {
    ...
    fun img(img: Image?, x: Int, y: Int): GraphicsProcessor {
        gg.drawImage(img, x, y, Game.instance.imageObserver)
        return this
    }

    fun img(img: Image?, x: Int, y: Int, width: Int, height: Int): GraphicsProcessor {
        gg.drawImage(img, x, y, width, height, Game.instance.imageObserver)
        return this
    }

    fun img(img: Image?, x: Int, y: Int, backgroundColor: Color?): GraphicsProcessor {
        gg.drawImage(img, x, y, backgroundColor, Game.instance.imageObserver)
        return this
    }

    fun img(img: Image?, x: Int, y: Int, width: Int, height: Int, backgroundColor: Color?): GraphicsProcessor {
        gg.drawImage(img, x, y, width, height, backgroundColor, Game.instance.imageObserver)
        return this
    }

    fun img(img: Image?, dx1: Int, dy1: Int, dx2: Int, dy2: Int, sx1: Int, sy1: Int, sx2: Int, sy2: Int): GraphicsProcessor {
        gg.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, Game.instance.imageObserver)
        return this
    }
    ...
    fun img(img: Image?, dx1: Int, dy1: Int, dx2: Int, dy2: Int, sx1: Int, sy1: Int, sx2: Int, sy2: Int, backgroundColor: Color?): GraphicsProcessor {
        gg.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, backgroundColor, Game.instance.imageObserver)
        return this
    }
