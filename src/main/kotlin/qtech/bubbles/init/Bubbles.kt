...
import qtech.bubbles.bubble.*
import qtech.bubbles.bubble.AbstractBubble.Companion.builder
...
import qtech.bubbles.core.utils.categories.ColorUtils.parseColorString
...
object Bubbles : ObjectInit<AbstractBubble?> {
    val BUBBLES: DeferredRegister<AbstractBubble> = DeferredRegister.create(BBInternalMod.ADDON_ID, Registers.BUBBLES)
