...
class LocalAddonEventBus<J : ModInstance> : EventBus {
    private val modInstance: ModObject<out ModInstance>

    constructor(addon: J) {
        this.modInstance = addon.`object`
    }

    constructor(modInstance: ModObject<out ModInstance>) {
...
//                    val get: EventBus = a.bus.bus().get()
    ...
    val modObject: ModObject<J>
        get() = modInstance as ModObject<J>

    fun getAddon(): J {
        return modInstance.addon as J
    }
