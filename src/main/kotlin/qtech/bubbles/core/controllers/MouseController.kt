...
import qtech.bubbles.event.MouseMotionEvent
...
class MouseController private constructor() : MouseAdapter() {
    ...
    override fun mouseClicked(e: MouseEvent) {
        ...
        BubbleBlaster.eventBus.post(qtech.bubbles.event.MouseEvent(BubbleBlaster.instance, this, e, MouseEventType.CLICK))
    }

    override fun mousePressed(e: MouseEvent) {
        currentLocationOnScreen = if (e.locationOnScreen != null) e.locationOnScreen else currentLocationOnScreen
        currentPoint = e.point
        BubbleBlaster.eventBus.post(qtech.bubbles.event.MouseEvent(BubbleBlaster.instance, this, e, MouseEventType.PRESS))
    }

    override fun mouseReleased(e: MouseEvent) {
        currentLocationOnScreen = if (e.locationOnScreen != null) e.locationOnScreen else currentLocationOnScreen
        currentPoint = e.point
        BubbleBlaster.eventBus.post(qtech.bubbles.event.MouseEvent(BubbleBlaster.instance, this, e, MouseEventType.RELEASE))
    }
    ...
    override fun mouseWheelMoved(e: MouseWheelEvent) {
        currentLocationOnScreen = if (e.locationOnScreen != null) e.locationOnScreen else currentLocationOnScreen
        currentPoint = e.point
        BubbleBlaster.eventBus.post(qtech.bubbles.event.MouseWheelEvent(BubbleBlaster.instance, this, e, MouseEventType.MOTION))
    }
