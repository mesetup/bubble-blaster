 ...
 * @author cpw
 */
class ModClassLoader(parent: ClassLoader?) : URLClassLoader(arrayOfNulls(0), null) {
    ...
    @get:Throws(ModLoaderException::class)
    ...
    //        ModAPITransformer addonAPI = (ModAPITransformer) transformers.get(transformers.size()-1);
