...
import qtech.bubbles.settings.GameSettings.Companion.instance
...
class SvgHelper {
    ...
    fun getImage(width: Int, height: Int): Image {
        ...
        if (BubbleBlaster.instance.graphicsConfigurator.isAntialiasingEnabled && instance().isAntialiasEnabled) g2d.hint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON)
