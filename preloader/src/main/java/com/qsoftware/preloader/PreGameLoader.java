package com.qsoftware.preloader;
...
public class PreGameLoader {
    ...
    private static final String QBUBBLES_LOADER = "com.qsoftware.preloader.QBubblesLoader";
    ...
    private void loadGame(String[] args) {
        try {
            ...
            final String launchTarget = Objects.requireNonNull(loader).getLoadingTarget();
            final Class<?> clazz = Class.forName(launchTarget, false, classLoader);
            final Method mainMethod = clazz.getMethod("launch", String[].class, PreClassLoader.class);

            LOGGER.info(String.format("Loading QBubbles {%s}", launchTarget));
