...
public class PreClassLoader extends URLClassLoader {
    ...
    public PreClassLoader(URL[] sources) {
        ...
        addInternalPackage("com.qsoftware.bubbles.");
        addInternalPackage("com.qsoftware.preloader.");
        addInternalPackage("com.qsoftware.dev.");
    }
    ...
    public Class<?> findClass(final String name) throws ClassNotFoundException {
        ...
        try {
            ...
            // Check for external.
            if (lastDot > 0 && !name.startsWith("com.qsoftware.bubbles.")) {
