...
import com.qtech.bubbleblaster.graphics.Border;
...
//                text += c;
    ...
    public void render(GraphicsProcessor gg) {
        ...
        if (activated) {
            ...
            gg.setColor(new Color(79, 79, 79));
            gg.fill(bounds);
        }

        GraphicsProcessor gg1 = gg.create(bounds.x, bounds.y, bounds.width, bounds.height);
        gg1.setColor(new Color(255, 255, 255, 255));
        ...
        int cursorX;
        gg1.setColor(new Color(0, 192, 192, 255));
        if (cursorIndex >= text.length()) {
            ...
            gg1.drawLine(cursorX, 2, cursorX, bounds.height - 5);
            gg1.drawLine(cursorX + 1, 2, cursorX + 1, bounds.height - 5);
        } else {
            if (text.length() != 0) {
                cursorX = fontMetrics.stringWidth(text.substring(0, cursorIndex)) + 8;
            } else {
            ...
            gg1.drawLine(cursorX, bounds.height - 5, cursorX + width, bounds.height - 5);
            gg1.drawLine(cursorX, bounds.height - 4, cursorX + width, bounds.height - 4);
        }
...
//            gg.draw(bounds);
            ...
            GraphicsProcessor gg1 = gg.create(bounds.x + 1, bounds.y + 1, bounds.width - 2, bounds.height - 2);
