package com.qtech.bubbleblaster.common.gametype;
...
import com.qtech.bubbleblaster.common.*;
import com.qtech.bubbleblaster.common.bubble.BubbleSystem;
import com.qtech.bubbleblaster.common.entity.AbstractBubbleEntity;
import com.qtech.bubbleblaster.common.entity.DamageSource;
import com.qtech.bubbleblaster.common.entity.DamageableEntity;
import com.qtech.bubbleblaster.common.entity.Entity;
import com.qtech.bubbleblaster.common.gamestate.GameEvent;
import com.qtech.bubbleblaster.common.interfaces.DefaultStateHolder;
import com.qtech.bubbleblaster.common.interfaces.Listener;
...
import com.qtech.bubbleblaster.common.random.QBRandom;
...
import com.qtech.bubbleblaster.event.RenderEvent;
...
import com.qtech.bubbleblaster.graphics.Animation;
import com.qtech.bubbleblaster.init.Bubbles;
import com.qtech.bubbleblaster.init.GameEvents;
import com.qtech.bubbleblaster.registry.Registers;
import com.qtech.bubbleblaster.registry.Registry;
import com.qtech.bubbleblaster.util.CollectionsUtils;
import org.bson.*;
...
public abstract class AbstractGameType extends RegistryEntry implements StateHolder, DefaultStateHolder, Listener {
     ...
     */
    @SuppressWarnings("EmptyMethod")
    public abstract void render(GraphicsProcessor gg);
...
//        System.out.println("REMOVE_DIFF_MOD_002: " + stateDifficultyModifiers);
    ...
    public abstract void renderHUD(GraphicsProcessor gg);

    @SuppressWarnings("EmptyMethod")
    public abstract void renderGUI(GraphicsProcessor gg);

    public void drawBubble(GraphicsProcessor g, double x, double y, int radius, Color... colors) {
        double i = 0f;
...
//                System.out.println("Holy Quackemoly");
    ...
    public void stopBloodMoon() {
        ...
        BubbleBlaster.getInstance().getGraphicsEngine().resetAntialiasing();
    }
