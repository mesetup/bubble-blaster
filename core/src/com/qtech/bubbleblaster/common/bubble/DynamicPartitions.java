package com.qtech.bubbleblaster.common.bubble;

import com.qtech.bubbleblaster.common.runnables.Applier;
import com.qtech.bubbleblaster.core.exceptions.ValueExists;
...
public class DynamicPartitions<T> {
    List<Double> sizes = new ArrayList<>();
    final List<T> values = new ArrayList<>();

    Double totalSize = 0d;

    public DynamicPartitions() {
     ...
     */
    public synchronized int add(double size, T value) throws ValueExists {
...
//            System.out.println("005_B: " + currentSize);
    ...
    public synchronized void editLengths(Applier<T, Double> applier) {
        double currentSize = 0;
