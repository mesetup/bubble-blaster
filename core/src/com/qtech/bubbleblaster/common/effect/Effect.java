package com.qtech.bubbleblaster.common.effect;
...
import com.qtech.bubbleblaster.util.helpers.SvgHelper;
...
public abstract class Effect extends RegistryEntry {
    ...
    static {
        ...
        GraphicsProcessor gg = (GraphicsProcessor) image.getGraphics();
