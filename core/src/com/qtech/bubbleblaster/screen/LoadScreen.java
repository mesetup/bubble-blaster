...
import com.qtech.bubbleblaster.data.GlobalSaveData;
import com.qtech.bubbleblaster.event.Bus;
import com.qtech.bubbleblaster.event.LoaderLoadCompleteEvent;
import com.qtech.bubbleblaster.event.TextureRenderEvent;
import com.qtech.bubbleblaster.event.XInputEventThread;
import com.qtech.bubbleblaster.event.bus.EventBus;
import com.qtech.bubbleblaster.event.registry.RegistryEvent;
import com.qtech.bubbleblaster.graphics.TextureCollection;
import com.qtech.bubbleblaster.registry.AddonManager;
import com.qtech.bubbleblaster.registry.Registers;
import com.qtech.bubbleblaster.registry.Registry;
import com.qtech.bubbleblaster.registry.object.ObjectHolder;
...
//            g2d.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
    ...
    public void run() {
        ...
        mainProgress.increment();
        BubbleBlaster.getEventBus().post(new LoaderLoadCompleteEvent(addonLoader));
    ...
    protected final void loadObjectHolders() {
        List<AddonContainer> containers = com.qtech.bubbleblaster.addon.loader.AddonManager.getInstance().getContainers();
