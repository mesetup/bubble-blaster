...
//        }
    ...
    public void renderGUI(BubbleBlaster game, GraphicsProcessor gg) {
        ...
        GraphicsProcessor gg1 = (GraphicsProcessor) gg.create((int) BubbleBlaster.getMiddleX() - 256, (int) BubbleBlaster.getMiddleY() - 149, 512, 300);
        GraphicsProcessor gg2;
        if (animation1 != null) {
            if (animation1.isEnded()) {
                ...
                gg2 = (GraphicsProcessor) gg1.create(x, 0, 512, 300);
            } else {
            ...
            if (animation2 != null) {
                if (animation2.isEnded()) {
                    gg2 = (GraphicsProcessor) gg1.create(0, 0, 512, 300);
                    animation2 = null;
                } else {
                    int x = (int) animation2.animate();
                    gg2 = (GraphicsProcessor) gg1.create(x, 0, 512, 300);
    ...
    public synchronized void renderBackground(GraphicsProcessor gg) {
