package com.qtech.bubbleblaster.addon.loader;
...
import com.qtech.bubbleblaster.common.crash.CrashCategory;
...
import com.qtech.bubbleblaster.event.old.ADLAddonSetupEvent;
import com.qtech.bubbleblaster.registry.AddonManager;
import com.qtech.bubbleblaster.registry.LocaleManager;
...
//    private final List<AddonContainer> containers = new ArrayList<>();
    ...
    public void constructAddons() {
        ...
        com.qtech.bubbleblaster.addon.loader.AddonManager addonManager = com.qtech.bubbleblaster.addon.loader.AddonManager.getInstance();
...
//            Class<?> c = addonClassLoader.loadClass(className);
            ...
            for (Class<?> clazz : classes) {
                ...
                if (addon != null) {
                    ...
                    com.qtech.bubbleblaster.addon.loader.AddonManager.registerContainer(addonContainer);
