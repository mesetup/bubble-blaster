package com.qtech.bubbleblaster.util.helpers;
...
public final class SvgHelper {
    ...
    public Image getImage(int width, int height) {
        ...
        GraphicsProcessor g2d = (GraphicsProcessor) bufferedImage.getGraphics();

        // For a smooth graphic with no jagged edges or rasterized look.

        if (BubbleBlaster.getInstance().getGraphicsEngine().isAntialiasingEnabled() && GameSettings.instance().isAntialiasEnabled())
